    ...
    client.on('ready', () => {
        ...
        client.ws.on('INTERACTION_CREATE', async interaction => {
            ...
            const inviteembed = new Discord.MessageEmbed()
                ...
                .setDescription(`[\`Click here\`](https://dc.apsarabot.xyz)   |   [\`Website\`](https://apsarabot.xyz)   |   :heart: Thanks for inviting!`)
                .setFooter(client.user.username + " | Syntax:  <>...must    []...optional", client.user.displayAvatarURL())
                .setAuthor(interaction.member.user.username, client.user.displayAvatarURL(), "https://dc.apsarabot.xyz")
            ...
            const infoembed = new Discord.MessageEmbed()
                .setAuthor(
                    ...
                    client.user.displayAvatarURL(), "https://dc.apsarabot.xyz"
                )
                .setColor(config.colors.yes)
                .addFields({
                        name: 'Bot tag',
