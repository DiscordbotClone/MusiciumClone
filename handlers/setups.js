...
module.exports = (client) => {
    ...
    client.on("ready", () => {
        setInterval(() => {
            ...
            if (stateswitch) client.user.setActivity(`${config.prefix}help | apsarabot.xyz`, {
                type: "PLAYING"
            });
    ...
    function getAll(client, guild) {
        const embed = new MessageEmbed()
            ...
            .addField("**__CLONE BY:__**", `
                >>> <@442355791412854784> \`Tentennnn#6944\` [\`Website\`](https://apsarabot.xyz) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=829031792325165156&permissions=8&scope=bot)
                `)
