    ...
    try {
        let embed = new Discord.MessageEmbed()
            ...
            .setAuthor(message.author.tag, message.member.user.displayAvatarURL({
                dynamic: true
            }), "https://dc.apsarabot.xyz")
            .setFooter(client.user.username + " | by: dc.apsarabot.xyz", client.user.displayAvatarURL());
    ...
    try {
        ...
        for (let i = 0; i < queue.songs.length; i += 10) {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setFooter(client.user.username + " | by: apsarabot.xyz", client.user.displayAvatarURL())
            embeds.push(embed);
        }
        //returning the Embed
        return embeds;
